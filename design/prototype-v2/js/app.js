...
document.addEventListener('DOMContentLoaded', () => {
    ...
    themes.forEach(theme => {
        ...
        // Inner HTML
        btn.innerHTML = `
            <div class="absolute top-2 right-2 bg-brand text-black rounded-full p-0.5 z-10 shadow-lg check-icon scale-0 transition-transform">
                <span class="material-symbols-outlined block text-[14px] font-bold">check</span>
            </div>
    ...
    // Input Listener to update preview text live
    ...
    // Text Input Focus Effect on Sidebar (Optional - visually handled by CSS focus-within)
