...
def create_poster(city, country, point, dist, output_file,
    ...
    Args:
        ...
        show_city_name: Whether to show city name text
        show_country_name: Whether to show country name text
    ...
    # Define poster size configurations
    SIZE_CONFIGS = {
        '18x24': (12, 16),    # 3:4 ratio
        '24x36': (12, 18),    # 2:3 ratio
        '12x16': (9, 12),     # 3:4 ratio
        'A3': (11.7, 16.5),   # ~1:1.41 ISO
        'A2': (16.5, 23.4),   # ~1:1.41 ISO
    }
    
    # Get figure size from config
    fig_size = SIZE_CONFIGS.get(poster_size, (12, 16))
    ...
    # 4. Typography using Roboto font (conditional based on flags)
    if FONTS:
    ...
    # Divider line (only if any text is shown)
    if show_city_name or show_country_name:
